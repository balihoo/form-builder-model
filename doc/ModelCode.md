...
* **template** *field name or field object* - The field's output value is generated by rendering the specified template field in Mustache. This property cannot be assigned to a field that also uses the dynamicValue field function.
